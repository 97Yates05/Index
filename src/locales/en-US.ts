...
export default {
  ...
  skillItem3: 'HTML, CSS(proficiency)',
  skillItem4: 'TypeScript(Familiar)',
  skillItem5: 'antd, element-ui(Familiar)',
  skillItem6: 'TCP/IP Network(Know)',
  skillItem7: 'Node.js, Webpack(Know)',
  skillItem8: 'Common Algorithms(Know)',
  skillItem9: 'Graphql, Dgraph(Used)',
  skillItem10: 'Docker, Jenkins(Used)',
  skillItem11: 'FWWB(The Second Prize)',
  skillItem12: 'CET-4, CET-6',
  skillItem13: 'Outstanding Volunteer',
